...
(i.e. activation functions (and their derivatives), matrix/tensor multiplication etc.)

Nothing is intended to be efficient or practical

To do:
Maybe visualise neural network?